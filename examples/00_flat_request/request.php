...
// Read API v3.6, the version this fork targets. `fields` keeps the response small and `lc`
...
try {
    ...
    // An HTML error page instead of JSON: the upstream example crashed with a TypeError here.
