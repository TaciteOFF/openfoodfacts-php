...
| [`02_demo`](02_demo) | A complete application: read, search, staging edits, photo upload, FR/EN interface and the raw JSON response panel. Live at <https://openfoodfacts-php-demo.fly.dev/> |
...
`02_demo` is a standalone application with its own `composer.json`:
